...
create table if not exists directed_join_tags_problem_spaces
(
id integer primary key,
parent_id integer,
child_id integer
...
create table if not exists directed_join_tags_operators
(
id integer primary key,
parent_id integer,
child_id integer
...
create table if not exists directed_join_tags_rules
(
id integer primary key,
parent_id integer,
child_id integer
...
-- Directed for tags as children

create table if not exists directed_join_problem_spaces_tags
(
id integer primary key,
parent_id integer,
child_id integer
...
create table if not exists directed_join_operators_tags
(
id integer primary key,
parent_id integer,
child_id integer
...
create table if not exists directed_join_tags_tags
(
id integer primary key,
parent_id integer,
child_id integer
