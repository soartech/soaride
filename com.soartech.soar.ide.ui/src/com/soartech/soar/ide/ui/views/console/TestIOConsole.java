 ...
 *
 */
public class TestIOConsole extends IOConsole {
...
//    private IConsoleColorProvider fColorProvider;
    ...
    public TestIOConsole(String name) {
        super(name, null);
...
//        fStreamsProxy = process.getStreamsProxy();
    ...
    public IPageBookViewPage createPage(IConsoleView view) {
        return new TestConsolePage(this, view);
    }
    
    public class TestConsolePage extends TextConsolePage
    {
           public TestConsolePage(TextConsole console, IConsoleView view) {
            super(console, view);
        }

        @Override
        protected TextConsoleViewer createViewer(Composite parent) {
            return new TestConsoleViewer(parent, (TestIOConsole) this.getConsole());
        }
    }
